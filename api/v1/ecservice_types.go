...
type ECService struct {
	...
	Spec   ECServiceSpec   `json:"spec,omitempty"`
	Status ECServiceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ECServiceList contains a list of ECService
type ECServiceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ECService `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ECService{}, &ECServiceList{})
}
